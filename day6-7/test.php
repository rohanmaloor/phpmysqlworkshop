...
if (isset($fnamer,$unamer,$passr,$repassr)) 
{
	...
	if($result)
	{
		...
		{
			$write = "INSERT INTO student_portal (id, full_name, username, password) VALUES ('', '$fnamer', '$unamer', '$passr')";
...
<html>
	...
	<table>
		<tr>
			<td>PHP marks: </td>
			<td><?php echo "$php_marks";?></td>
		</tr>
		<tr>
			<td>MySQL marks: </td>
			<td><?php echo "$sql_marks";?></td>
		</tr>
		<tr>
			<td>HTML marks: </td>
			<td><?php echo "$html_marks";?></td>
		</tr>
		<tr>
			<td>Percentage: </td>
			<td><?php echo "$perc";?></td>
...
$headers = "From: rohanmaloor@gmail.com";
